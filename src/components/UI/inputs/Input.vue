    ...
    <div>
        <div class="relative select-none h-14 w-full">
            ...
            <input :autocomplete="props.type == 'password' ? 'new-password' : 'off'" :type="props.type" :id="props.label"
                class="peer w-full h-full pt-3 px-3 text-sm border border-gray-300 rounded-[4px] focus:border-primary focus:border-2 outline-none transition-all text-gray-700 placeholder-transparent peer-valid:pt-4"
