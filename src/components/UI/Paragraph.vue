...
<template>
  <div @click.stop class="relative w-full max-w-full">
    ...
    @click="toggleExpand"
      ...
      :class="[
        custom,
        'text-text-gray text-sm overflow-hidden break-words whitespace-pre-wrap',
    ...
    <button
      v-if="needsTruncate"
      @click="toggleExpand"
      class="mt-1 text-primary-500 hover:text-primary-600 font-medium text-sm focus:outline-none transition-colors"
    >
